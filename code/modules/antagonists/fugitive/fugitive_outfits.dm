...
/datum/outfit/waldo/post_equip(mob/living/carbon/human/H, visualsOnly=FALSE)
	...
	no_drops += H.get_item_by_slot(INV_SLOTBIT_FEET)
	no_drops += H.get_item_by_slot(INV_SLOTBIT_ICLOTHING)
	no_drops += H.get_item_by_slot(INV_SLOTBIT_OCLOTHING)
	no_drops += H.get_item_by_slot(INV_SLOTBIT_HEAD)
	no_drops += H.get_item_by_slot(INV_SLOTBIT_EYES)
