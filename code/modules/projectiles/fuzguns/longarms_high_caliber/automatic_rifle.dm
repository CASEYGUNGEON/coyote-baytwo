// FAL is the baseline
/obj/item/gun/ballistic/automatic/ra
	name = "automatic rifle template"								// use a simple common name. do NOT go overly esoteric or extravagant
...
/obj/item/gun/ballistic/automatic/ra/fal
	name = " worn FAL"
	desc = "An automatic rifle chambered in .308."
/obj/item/gun/ballistic/automatic/ra/fal/q2
	name = "FAL"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/ra/fal/q3
	name = "unrusted FAL"
	max_upgrades = 5
