// bren is the baseline
/obj/item/gun/ballistic/automatic/mmg
	name = "medium machine gun template"								// use a simple common name. do NOT go overly esoteric or extravagant
...
/obj/item/gun/ballistic/automatic/mmg/bren
	name = " worn Bren gun"
	desc = "A medium machinegun chambered in .308."
/obj/item/gun/ballistic/automatic/mmg/bren/q2
	name = "Bren gun"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/mmg/bren/q3
	name = "unrusted Bren gun"
	max_upgrades = 5
