// AR-10 is baseline
/obj/item/gun/ballistic/automatic/br
	name = "battle rifle template"								// use a simple common name. do NOT go overly esoteric or extravagant
...
/obj/item/gun/ballistic/automatic/br/ar10
	name = " worn AR-10"
	desc = "A battle rifle chambered in .308."
/obj/item/gun/ballistic/automatic/br/ar10/q2
	name = "AR-10"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/br/ar10/q3
	name = "unrusted AR-10"
	max_upgrades = 5
