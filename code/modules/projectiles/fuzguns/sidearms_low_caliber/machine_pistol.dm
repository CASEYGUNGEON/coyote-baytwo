// mac-10 is baseline
/obj/item/gun/ballistic/automatic/mp
...
// cosmetic vars
	icon_state = "mac10"											// the object's sprite name
	...
	inhand_icon_state = "uzi"										// the inhand sprite name
...
// performance vars
	...
	disallowed_mags = list(/obj/item/ammo_box/magazine/uzim9mm/rockwell)	// members of magazine family it cannot fit
	init_firemodes = list(
		/datum/firemode/automatic/rpm1200,
		/datum/firemode/semi_auto/rpm1200
	)
	init_recoil = SMG_RECOIL(2, 2)									// recoil: first number modifies 1h recoil. second number modifies 2h recoil
...
/obj/item/gun/ballistic/automatic/mp/mac10
	name = "worn MAC-10"
	desc = "A machine pistol chambered in 9x19mm."
	suppressor_state = "uzi_suppressor"
	suppressor_x_offset = 28
	suppressor_y_offset = 20
/obj/item/gun/ballistic/automatic/mp/mac10/q2
	name = "MAC-10"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/mp/mac10/q3
	name = "unrusted MAC-10"
	max_upgrades = 5
