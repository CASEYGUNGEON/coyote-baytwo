...
// cosmetic vars
	...
	inhand_icon_state = "arg"										// the inhand sprite name
...
// performance vars
	...
	mag_type = /obj/item/ammo_box/magazine/a9mm/thirty				// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/a9mm/thirty			// specific mag it starts with 
	...
	init_recoil = SMG_RECOIL(1, 1)							// recoil: first number modifies 1h recoil. second number modifies 2h recoil
...
// handling vars
	...
	slowdown = GUN_SLOWDOWN_SMG_LIGHT								// move speed penalty when drawn
