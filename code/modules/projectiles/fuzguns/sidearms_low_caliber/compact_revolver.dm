...
/obj/item/gun/ballistic/revolver/compact_revolver
	name = "compact revolver template"								// use a simple common name. do NOT go overly esoteric or extravagant
	desc = "should not be here, bugreport."							// use the format "A submachine gun chambered in caliber. Optional flavor text goes here."
// cosmetic vars
	icon_state = "police"												// the object's sprite name
...
// performance vars
	...
	mag_type = /obj/item/ammo_box/magazine/internal/cylinder/a38/six		// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/internal/cylinder/a38/six	// specific mag it starts with 
...
//revolver handling vars
	...
	rotate_direction = REV_ADVANCE_BACKWARD 						// defines for 1 or -1. see combat.dm
...
/obj/item/gun/ballistic/revolver/compact_revolver/m10
	name = " worn Model 10"
	desc = "A compact revolver chambered in .38 Special."
/obj/item/gun/ballistic/revolver/compact_revolver/m10/q2
	name = "Model 10"
	max_upgrades = 4
/obj/item/gun/ballistic/revolver/compact_revolver/m10/q3
	name = "unrusted Model 10"
	max_upgrades = 5
