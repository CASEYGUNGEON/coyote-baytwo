...
/obj/item/gun/ballistic/automatic/semiauto_rifle
	name = "semiauto rifle template"								// use a simple common name. do NOT go overly esoteric or extravagant
	desc = "should not be here, bugreport."							// use the format "A submachine gun chambered in caliber. Optional flavor text goes here."
// cosmetic vars
	icon_state = "service_rifle"									// the object's sprite name
	icon = 'icons/obj/guns/projectile.dmi'					// location of the sprite
	mob_overlay_icon = null											// location of the back sprite. Uses icon_state. set this to null if not applicable
	inhand_icon_state = "servicerifle"								// the inhand sprite name
...
// performance vars
	...
	init_recoil = CARBINE_RECOIL(1, 1)								// recoil: first number modifies 1h recoil. second number modifies 2h recoil
...
// handling vars
	...
	slowdown = GUN_SLOWDOWN_RIFLE_LIGHT_AUTO						// move speed penalty when drawn
...
/obj/item/gun/ballistic/automatic/semiauto_rifle/ar15
	name = " worn AR-15"
	desc = "A semiauto rifle chambered in .223."
/obj/item/gun/ballistic/automatic/semiauto_rifle/ar15/q2
	name = "AR-15"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/semiauto_rifle/ar15/q3
	name = "unrusted AR-15"
	max_upgrades = 5
