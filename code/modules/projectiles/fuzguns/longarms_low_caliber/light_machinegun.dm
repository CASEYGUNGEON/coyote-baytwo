...
/obj/item/gun/ballistic/automatic/automatic/lmg
	name = "worn M249"
	desc = "A light machine gun chambered in .223."
/obj/item/gun/ballistic/automatic/automatic/lmg/q2
	name = "M249"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/automatic/lmg/q3
	name = "unrusted M249"
	max_upgrades = 5
