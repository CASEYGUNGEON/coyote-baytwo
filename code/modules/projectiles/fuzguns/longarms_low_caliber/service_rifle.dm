...
/obj/item/gun/ballistic/automatic/sr
	name = "service rifle template"								// use a simple common name. do NOT go overly esoteric or extravagant
...
/obj/item/gun/ballistic/automatic/sr/ar15
	name = " worn AR-15"
	desc = "A service rifle chambered in .223."
/obj/item/gun/ballistic/automatic/sr/ar15/q2
	name = "AR-15"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/sr/ar15/q3
	name = "unrusted AR-15"
	max_upgrades = 5
