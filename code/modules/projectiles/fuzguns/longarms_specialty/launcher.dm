/obj/item/gun/ballistic/revolver/launcher
	name = "launcher template"										// use a simple common name. do NOT go overly esoteric or extravagant
	desc = "should not be here, bugreport."							// use the format "A submachine gun chambered in caliber. Optional flavor text goes here."
// cosmetic vars
	icon_state = "m79"												// the object's sprite name
	icon = 'modular_coyote/icons/objects/gun.dmi'					// location of the sprite
	mob_overlay_icon = null											// location of the back sprite. Uses icon_state. set this to null if not applicable
	inhand_icon_state = "shotgundouble"								// the inhand sprite name
	...
	ejector_side = GUN_EJECTOR_ANY									// direction casings are ejected
// performance vars
	damage_multiplier = GUN_EXTRA_DAMAGE_0							// weapon damage modifier
	mag_type = /obj/item/ammo_box/magazine/internal/cylinder/a40mm/one		// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/internal/cylinder/a40mm/one	// specific mag it starts with 
	...
	init_recoil = SHOTGUN_RECOIL(5, 1)								// recoil: first number modifies 1h recoil. second number modifies 2h recoil
...
// melee vars
	...
	attack_speed = CLICK_CD_MELEE									// delay between attacks
...
//revolver handling vars
	kind = REVKIND_BREAK_ACTION_SHOTGUN								// loading style
	cock_method = REVCOCK_DOUBLE_ACTION								// determines double or single action
...
/obj/item/gun/ballistic/revolver/launcher/m79
	name = "worn M79 Thumper"
	desc = "A launcher chambered in 40mm. Affectionally known as the Bloop Gun."
/obj/item/gun/ballistic/revolver/launcher/m79/q2
	name = "M79 Thumper"
	max_upgrades = 4
/obj/item/gun/ballistic/revolver/launcher/m79/q3
	name = "unrusted M79 Thumper"
	max_upgrades = 5
