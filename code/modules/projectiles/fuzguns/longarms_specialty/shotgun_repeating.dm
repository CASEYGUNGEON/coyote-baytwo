...
/obj/item/gun/ballistic/shotgun/repeating_shotgun
	name = "repeating shotgun template"								// use a simple common name. do NOT go overly esoteric or extravagant
	desc = "should not be here, bugreport."							// use the format "A submachine gun chambered in caliber. Optional flavor text goes here."
// cosmetic vars
	icon_state = "pump"												// the object's sprite name
	...
	inhand_icon_state = "huntingshotgun"							// the inhand sprite name
...
// performance vars
	...
	mag_type = /obj/item/ammo_box/magazine/internal/cylinder/a12g/five		// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/internal/cylinder/a12g/five	// specific mag it starts with 
	...
	init_recoil = SHOTGUN_RECOIL(1, 1)								// recoil: first number modifies 1h recoil. second number modifies 2h recoil
...
/obj/item/gun/ballistic/shotgun/repeating_shotgun/r870
	name = " worn R870"
	desc = "A repeating shotgun chambered in 12 gauge. The most common pump shotgun on the market, back when there was a market."
/obj/item/gun/ballistic/shotgun/repeating_shotgun/r870/q2
	name = "R870"
	max_upgrades = 4
/obj/item/gun/ballistic/shotgun/repeating_shotgun/r870/q3
	name = "unrusted R870"
	max_upgrades = 5
