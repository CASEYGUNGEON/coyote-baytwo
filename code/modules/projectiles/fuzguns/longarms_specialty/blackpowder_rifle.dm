// brown bess is baseline


/obj/item/gun/flintlock/blackpowder_rifle
	name = "blackpowder rifle template"								// use a simple common name. do NOT go overly esoteric or extravagant
...
/obj/item/gun/flintlock/blackpowder_rifle/bess
	name = "worn Brown Bess"
	desc = "A blackpowder rifle chambered in .75 ball."
/obj/item/gun/flintlock/blackpowder_rifle/bess/q2
	name = "Brown Bess"
	max_upgrades = 4
/obj/item/gun/flintlock/blackpowder_rifle/bess/q3
	name = "unrusted Brown Bess"
	max_upgrades = 5
