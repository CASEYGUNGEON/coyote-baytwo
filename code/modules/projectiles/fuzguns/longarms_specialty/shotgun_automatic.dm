...
/obj/item/gun/ballistic/automatic/sa
...
// cosmetic vars
	icon_state = "pancor"											// the object's sprite name
	...
	inhand_icon_state = "cshotgun1"									// the inhand sprite name
...
// performance vars
	...
	mag_type = /obj/item/ammo_box/magazine/d12g						// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/d12g				// specific mag it starts with 
	...
	init_recoil = AUTOSHOTGUN_RECOIL(1, 0.8)							// recoil: first number modifies 1h recoil. second number modifies 2h recoil
...
/obj/item/gun/ballistic/automatic/sa/jackhammer
	name = "worn Jackhammer"
	desc = "An automatic shotgun chambered in 12 gauge. Only three were ever made, and two of those were destroyed. Yet somehow the weapon became the most common and famous automatic shotguns in media."
/obj/item/gun/ballistic/automatic/sa/jackhammer/q2
	name = "Jackhammer"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/sa/jackhammer/q3
	name = "unrusted Jackhammer"
	max_upgrades = 5
