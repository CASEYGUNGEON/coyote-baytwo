...
/obj/item/gun/ballistic/automatic/hsmg
...
// cosmetic vars
	...
	fire_sound = 'sound/f13weapons/greasegun.ogg' 					// null means the cartridge's sound is used.
	ejector_side = GUN_EJECTOR_RIGHT								// direction casings are ejected
// performance vars
	damage_multiplier = GUN_EXTRA_DAMAGE_0							// weapon damage modifier
	mag_type = /obj/item/ammo_box/magazine/greasegun				// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/greasegun			// specific mag it starts with 
...
/obj/item/gun/ballistic/automatic/hsmg/greasegun
	name = "worn Grease Gun"
	desc = "A heavy smg chambered in .45 ACP."
	suppressor_state = "uzi_suppressor"
	suppressor_x_offset = 26
	suppressor_y_offset = 19
/obj/item/gun/ballistic/automatic/hsmg/greasegun/q2
	name = "Grease Gun"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/hsmg/greasegun/q3
