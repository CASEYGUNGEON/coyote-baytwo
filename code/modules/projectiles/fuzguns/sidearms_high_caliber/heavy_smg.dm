...
/obj/item/gun/ballistic/automatic/heavy_smg
	name = "heavy smg template"										// use a simple common name. do NOT go overly esoteric or extravagant
	desc = "should not be here, bugreport."							// use the format "A submachine gun chambered in caliber. Optional flavor text goes here."
// cosmetic vars
	icon_state = "grease_gun"										// the object's sprite name
	...
	inhand_icon_state = "smg9mm"										// the inhand sprite name
...
// performance vars
	...
	mag_type = /obj/item/ammo_box/magazine/a45/thirty				// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/a45/thirty			// specific mag it starts with 
...
// handling vars
	...
	slowdown = GUN_SLOWDOWN_SMG_HEAVY							// move speed penalty when drawn
...
/obj/item/gun/ballistic/automatic/heavy_smg/greasegun
	name = "worn Grease Gun"
	desc = "A heavy smg chambered in .45 ACP."
	can_suppress = TRUE
	suppressor_state = "uzi_suppressor"
	suppressor_x_offset = 26
	suppressor_y_offset = 19
/obj/item/gun/ballistic/automatic/heavy_smg/greasegun/q2
	name = "Grease Gun"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/heavy_smg/greasegun/q3
	name = "unrusted Grease Gun"
	max_upgrades = 5
