// M1911 is baseline
/obj/item/gun/ballistic/automatic/pistol/map
	name = "magnum autopistol template"								// use a simple common name. do NOT go overly esoteric or extravagant
	desc = "should not be here, bugreport."							// use the format "A submachine gun chambered in caliber. Optional flavor text goes here."
// cosmetic vars
	icon_state = "m1911"											// the object's sprite name
	...
	inhand_icon_state = "pistolchrome"								// the inhand sprite name
...
// performance vars
	...
	mag_type = /obj/item/ammo_box/magazine/m45						// family of magazines it can fit
	init_mag_type = /obj/item/ammo_box/magazine/m45					// specific mag it starts with 
	extra_mag_types = list()										// extra familes of magazines it can fit
	disallowed_mags = list(/obj/item/ammo_box/magazine/m45/socom, /obj/item/ammo_box/magazine/m45/socom/empty)	// members of magazine family it cannot fit
...
/obj/item/gun/ballistic/automatic/pistol/map/m1911
	name = "worn M1911"
	desc = "A magnum autopistol chambered in .45 ACP. Muh three world wars!"
	suppressor_state = "pistol_suppressor"
	suppressor_x_offset = 28
	suppressor_y_offset = 20
/obj/item/gun/ballistic/automatic/pistol/map/m1911/q2
	name = "M1911"
	max_upgrades = 4
/obj/item/gun/ballistic/automatic/pistol/map/m1911/q3
	name = "unrusted M1911"
	max_upgrades = 5
