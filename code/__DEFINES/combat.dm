...
#define BULLET_SURPLUS_MULT_SPEED 1.5
#define BULLET_HANDLOAD_MULT_SPEED 1

/// Bullet wounding modifier defines
#define BULLET_MATCH_MULT_WOUND 1.5
#define BULLET_SURPLUS_MULT_WOUND 1.25
#define BULLET_HANDLOAD_MULT_WOUND 1

/// Bullet recoil modifier defines
#define BULLET_MATCH_MULT_RECOIL 4
#define BULLET_SURPLUS_MULT_RECOIL 2
#define BULLET_HANDLOAD_MULT_RECOIL 1
...
//SMALL PISTOL
#define BULLET_DAMAGE_PISTOL_SMALL_HANDLOAD 20
#define BULLET_DAMAGE_PISTOL_SMALL_STANDARD (BULLET_DAMAGE_PISTOL_SMALL_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_PISTOL_SMALL_MATCH (BULLET_DAMAGE_PISTOL_SMALL_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_PISTOL_SMALL (BULLET_DAMAGE_PISTOL_SMALL_HANDLOAD * 0.5)
#define BULLET_RECOIL_PISTOL_SMALL_HANDLOAD BULLET_RECOIL_PISTOL_SMALL
#define BULLET_RECOIL_PISTOL_SMALL_STANDARD (BULLET_RECOIL_PISTOL_SMALL * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_PISTOL_SMALL_MATCH (BULLET_RECOIL_PISTOL_SMALL * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_PISTOL_SMALL_HANDLOAD (BULLET_SPEED_BASE)
#define BULLET_SPEED_PISTOL_SMALL_STANDARD (BULLET_SPEED_PISTOL_SMALL_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_PISTOL_SMALL_MATCH (BULLET_SPEED_PISTOL_SMALL_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_PISTOL_SMALL_HANDLOAD 5
#define BULLET_WOUND_PISTOL_SMALL_STANDARD (BULLET_WOUND_PISTOL_SMALL_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_PISTOL_SMALL_MATCH (BULLET_WOUND_PISTOL_SMALL_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_PISTOL_SMALL_NAKED_MULT 1

//LARGE PISTOL
#define BULLET_DAMAGE_PISTOL_LARGE_HANDLOAD 40
#define BULLET_DAMAGE_PISTOL_LARGE_STANDARD (BULLET_DAMAGE_PISTOL_LARGE_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_PISTOL_LARGE_MATCH (BULLET_DAMAGE_PISTOL_LARGE_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_PISTOL_LARGE (BULLET_DAMAGE_PISTOL_LARGE_HANDLOAD * 0.5)
#define BULLET_RECOIL_PISTOL_LARGE_HANDLOAD BULLET_RECOIL_PISTOL_LARGE
#define BULLET_RECOIL_PISTOL_LARGE_STANDARD (BULLET_RECOIL_PISTOL_LARGE * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_PISTOL_LARGE_MATCH (BULLET_RECOIL_PISTOL_LARGE * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_PISTOL_LARGE_HANDLOAD (BULLET_SPEED_BASE * 0.8)
#define BULLET_SPEED_PISTOL_LARGE_STANDARD (BULLET_SPEED_PISTOL_LARGE_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_PISTOL_LARGE_MATCH (BULLET_SPEED_PISTOL_LARGE_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_PISTOL_LARGE_HANDLOAD 10
#define BULLET_WOUND_PISTOL_LARGE_STANDARD (BULLET_WOUND_PISTOL_LARGE_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_PISTOL_LARGE_MATCH (BULLET_WOUND_PISTOL_LARGE_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_PISTOL_LARGE_NAKED_MULT 1

//SMALL RIFLE
#define BULLET_DAMAGE_RIFLE_SMALL_HANDLOAD 40
#define BULLET_DAMAGE_RIFLE_SMALL_STANDARD (BULLET_DAMAGE_RIFLE_SMALL_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_RIFLE_SMALL_MATCH (BULLET_DAMAGE_RIFLE_SMALL_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_RIFLE_SMALL (BULLET_DAMAGE_RIFLE_SMALL_HANDLOAD * 0.5)
#define BULLET_RECOIL_RIFLE_SMALL_HANDLOAD BULLET_RECOIL_RIFLE_SMALL
#define BULLET_RECOIL_RIFLE_SMALL_STANDARD (BULLET_RECOIL_RIFLE_SMALL * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_RIFLE_SMALL_MATCH (BULLET_RECOIL_RIFLE_SMALL * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_RIFLE_SMALL_HANDLOAD (BULLET_SPEED_BASE * 1.2)
#define BULLET_SPEED_RIFLE_SMALL_STANDARD (BULLET_SPEED_RIFLE_SMALL_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_RIFLE_SMALL_MATCH (BULLET_SPEED_RIFLE_SMALL_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_RIFLE_SMALL_HANDLOAD 10
#define BULLET_WOUND_RIFLE_SMALL_STANDARD (BULLET_WOUND_RIFLE_SMALL_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_RIFLE_SMALL_MATCH (BULLET_WOUND_RIFLE_SMALL_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_RIFLE_SMALL_NAKED_MULT 1

//LARGE RIFLE
#define BULLET_DAMAGE_RIFLE_LARGE_HANDLOAD 80
#define BULLET_DAMAGE_RIFLE_LARGE_STANDARD (BULLET_DAMAGE_RIFLE_LARGE_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_RIFLE_LARGE_MATCH (BULLET_DAMAGE_RIFLE_LARGE_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_RIFLE_LARGE (BULLET_DAMAGE_RIFLE_LARGE_HANDLOAD * 0.5)
#define BULLET_RECOIL_RIFLE_LARGE_HANDLOAD BULLET_RECOIL_RIFLE_LARGE
#define BULLET_RECOIL_RIFLE_LARGE_STANDARD (BULLET_RECOIL_RIFLE_LARGE * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_RIFLE_LARGE_MATCH (BULLET_RECOIL_RIFLE_LARGE * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_RIFLE_LARGE_HANDLOAD (BULLET_SPEED_BASE)
#define BULLET_SPEED_RIFLE_LARGE_STANDARD (BULLET_SPEED_RIFLE_LARGE_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_RIFLE_LARGE_MATCH (BULLET_SPEED_RIFLE_LARGE_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_RIFLE_LARGE_HANDLOAD 20
#define BULLET_WOUND_RIFLE_LARGE_STANDARD (BULLET_WOUND_RIFLE_LARGE_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_RIFLE_LARGE_MATCH (BULLET_WOUND_RIFLE_LARGE_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_RIFLE_LARGE_NAKED_MULT 1

//SHOTGUN SLUG
#define BULLET_DAMAGE_SHOTGUN_SLUG_HANDLOAD 80
#define BULLET_DAMAGE_SHOTGUN_SLUG_STANDARD (BULLET_DAMAGE_SHOTGUN_SLUG_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_SHOTGUN_SLUG_MATCH (BULLET_DAMAGE_SHOTGUN_SLUG_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_SHOTGUN_SLUG (BULLET_DAMAGE_SHOTGUN_SLUG_HANDLOAD * 0.5)
#define BULLET_RECOIL_SHOTGUN_SLUG_HANDLOAD BULLET_RECOIL_SHOTGUN
#define BULLET_RECOIL_SHOTGUN_SLUG_STANDARD (BULLET_RECOIL_SHOTGUN * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_SHOTGUN_SLUG_MATCH (BULLET_RECOIL_SHOTGUN * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_SHOTGUN_SLUG_HANDLOAD (BULLET_SPEED_BASE)
#define BULLET_SPEED_SHOTGUN_SLUG_STANDARD (BULLET_SPEED_SHOTGUN_SLUG_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_SHOTGUN_SLUG_MATCH (BULLET_SPEED_SHOTGUN_SLUG_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_SHOTGUN_SLUG_HANDLOAD 20
#define BULLET_WOUND_SHOTGUN_SLUG_STANDARD (BULLET_WOUND_SHOTGUN_SLUG_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_SHOTGUN_SLUG_MATCH (BULLET_WOUND_SHOTGUN_SLUG_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_SHOTGUN_SLUG_NAKED_MULT 1

//SHOTGUN BUCKSHOT
#define BULLET_DAMAGE_SHOTGUN_BUCK_HANDLOAD 9 // 9 * 9 = 80
#define BULLET_DAMAGE_SHOTGUN_BUCK_STANDARD (BULLET_DAMAGE_SHOTGUN_BUCK_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_SHOTGUN_BUCK_MATCH (BULLET_DAMAGE_SHOTGUN_BUCK_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_SHOTGUN_BUCK (BULLET_DAMAGE_SHOTGUN_BUCK_HANDLOAD * 0.5)
#define BULLET_RECOIL_SHOTGUN_BUCK_HANDLOAD BULLET_RECOIL_SHOTGUN
#define BULLET_RECOIL_SHOTGUN_BUCK_STANDARD (BULLET_RECOIL_SHOTGUN * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_SHOTGUN_BUCK_MATCH (BULLET_RECOIL_SHOTGUN * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_SHOTGUN_BUCK_HANDLOAD (BULLET_SPEED_BASE)
#define BULLET_SPEED_SHOTGUN_BUCK_STANDARD (BULLET_SPEED_SHOTGUN_BUCK_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_SHOTGUN_BUCK_MATCH (BULLET_SPEED_SHOTGUN_BUCK_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_SHOTGUN_BUCK_HANDLOAD 2
#define BULLET_WOUND_SHOTGUN_BUCK_STANDARD (BULLET_WOUND_SHOTGUN_BUCK_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_SHOTGUN_BUCK_MATCH (BULLET_WOUND_SHOTGUN_BUCK_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_SHOTGUN_BUCK_NAKED_MULT 1

//GRENADE SLUG
#define BULLET_DAMAGE_GRENADE_SLUG_HANDLOAD 120
#define BULLET_DAMAGE_GRENADE_SLUG_STANDARD (BULLET_DAMAGE_GRENADE_SLUG_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_GRENADE_SLUG_MATCH (BULLET_DAMAGE_GRENADE_SLUG_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_GRENADE_SLUG (BULLET_DAMAGE_GRENADE_SLUG_HANDLOAD * 0.5)
#define BULLET_RECOIL_GRENADE_SLUG_HANDLOAD BULLET_RECOIL_SHOTGUN
#define BULLET_RECOIL_GRENADE_SLUG_STANDARD (BULLET_RECOIL_SHOTGUN * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_GRENADE_SLUG_MATCH (BULLET_RECOIL_SHOTGUN * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_GRENADE_SLUG_HANDLOAD (BULLET_SPEED_BASE)
#define BULLET_SPEED_GRENADE_SLUG_STANDARD (BULLET_SPEED_GRENADE_SLUG_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_GRENADE_SLUG_MATCH (BULLET_SPEED_GRENADE_SLUG_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_GRENADE_SLUG_HANDLOAD 30
#define BULLET_WOUND_GRENADE_SLUG_STANDARD (BULLET_WOUND_GRENADE_SLUG_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_GRENADE_SLUG_MATCH (BULLET_WOUND_GRENADE_SLUG_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_GRENADE_SLUG_NAKED_MULT 1

//GRENADE BUCKSHOT
#define BULLET_DAMAGE_GRENADE_BUCK_HANDLOAD 7 // 7 * 18 = 126
#define BULLET_DAMAGE_GRENADE_BUCK_STANDARD (BULLET_DAMAGE_GRENADE_BUCK_HANDLOAD * BULLET_SURPLUS_MULT_DAMAGE)
#define BULLET_DAMAGE_GRENADE_BUCK_MATCH (BULLET_DAMAGE_GRENADE_BUCK_HANDLOAD * BULLET_MATCH_MULT_DAMAGE)
#define BULLET_STAMINA_GRENADE_BUCK (BULLET_DAMAGE_GRENADE_BUCK_HANDLOAD * 0.5)
#define BULLET_RECOIL_GRENADE_BUCK_HANDLOAD BULLET_RECOIL_SHOTGUN
#define BULLET_RECOIL_GRENADE_BUCK_STANDARD (BULLET_RECOIL_SHOTGUN * BULLET_SURPLUS_MULT_RECOIL)
#define BULLET_RECOIL_GRENADE_BUCK_MATCH (BULLET_RECOIL_SHOTGUN * BULLET_MATCH_MULT_RECOIL)
#define BULLET_SPEED_GRENADE_BUCK_HANDLOAD (BULLET_SPEED_BASE)
#define BULLET_SPEED_GRENADE_BUCK_STANDARD (BULLET_SPEED_GRENADE_BUCK_HANDLOAD * BULLET_SURPLUS_MULT_SPEED)
#define BULLET_SPEED_GRENADE_BUCK_MATCH (BULLET_SPEED_GRENADE_BUCK_HANDLOAD * BULLET_MATCH_MULT_SPEED)
#define BULLET_WOUND_GRENADE_BUCK_HANDLOAD 2
#define BULLET_WOUND_GRENADE_BUCK_STANDARD (BULLET_WOUND_GRENADE_BUCK_HANDLOAD * BULLET_SURPLUS_MULT_WOUND)
#define BULLET_WOUND_GRENADE_BUCK_MATCH (BULLET_WOUND_GRENADE_BUCK_HANDLOAD * BULLET_MATCH_MULT_WOUND)
#define BULLET_WOUND_GRENADE_BUCK_NAKED_MULT 1



/////////////////////////////////
//// DEPRECATED AMMO DEFINES ////
/////////////////////////////////
...
#define GUN_MELEE_FORCE_BASE 15

/// Gun weapon weight
#define GUN_MELEE_FORCE_PISTOL_LIGHT (15)
#define GUN_MELEE_FORCE_PISTOL_HEAVY (20)
#define GUN_MELEE_FORCE_RIFLE_LIGHT (25)
#define GUN_MELEE_FORCE_RIFLE_HEAVY (35)
#define GUN_MELEE_FORCE_RIFLE_GUNBLADE (45)
#define GUN_MELEE_FORCE_RIFLE_HEAVIER (55)
...
/* the categories of info */
#define REV_ALERT_NEED_LOADER_EXPOSED_TO_ROTATE         "REV_ALERT_NEED_LOADER_EXPOSED_TO_ROTATE"
#define REV_ALERT_CAN_ONLY_ROTATE_IN_ADVANCE_DIRECTION  "REV_ALERT_CAN_ONLY_ROTATE_IN_ADVANCE_DIRECTION"
#define REV_INFO_OPENED_GUN                             "REV_INFO_OPENED_GUN"
#define REV_INFO_CLOSED_GUN                             "REV_INFO_CLOSED_GUN"
#define REV_INFO_LOADED_SINGLE                          "REV_INFO_LOADED_SINGLE"
#define REV_INFO_EJECTED_SINGLEBIE                      "REV_INFO_EJECTED_SINGLEBIE"
#define REV_INFO_EJECTED_ALL                            "REV_INFO_EJECTED_ALL"
#define REV_INFO_EJECTED_EMPTIES                        "REV_INFO_EJECTED_EMPTIES"
#define REV_INFO_EJECTED_LOADEDS                        "REV_INFO_EJECTED_LOADEDS"

#define REV_EJECT_SINGLE          "REV_EJECT_SINGLE"
#define REV_EJECT_ALL             "REV_EJECT_ALL"
#define REV_EJECT_ADVANCED        "REV_EJECT_ADVANCED"

#define REV_BOTH_HALFCOCK_ONLY    "REV_BOTH_HALFCOCK_ONLY"
#define REV_BOTH_ALWAYS           "REV_BOTH_ALWAYS"
#define REV_ADVANCE_ONLY          "REV_ADVANCE_ONLY"

#define REV_FLAG_NEEDS_MAGAZINE        (1<<0)
#define REV_FLAG_NEEDS_LOADER_EXPOSED  (1<<1)

#define REVKIND_SWINGOUT_DOUBLE_ACTION "REVKIND_SWINGOUT_DOUBLE_ACTION"
#define REVKIND_SINGLE_ACTION_REVOLVER "REVKIND_SINGLE_ACTION_REVOLVER"
#define REVKIND_BREAK_ACTION_REVOLVER  "REVKIND_BREAK_ACTION_REVOLVER"
#define REVKIND_BREAK_ACTION_SHOTGUN   "REVKIND_BREAK_ACTION_SHOTGUN"

#define REVCOCK_SINGLE_ACTION "REVCOCK_SINGLE_ACTION"
#define REVCOCK_DOUBLE_ACTION "REVCOCK_DOUBLE_ACTION"
