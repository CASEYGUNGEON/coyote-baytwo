...
/obj/structure/closet/secure_closet/captains/PopulateContents() //Excess clothing and such can be found in the Captain's Wardrobe. You can also find this file in code/modules/vending/wardrobes.
	...
	new /obj/item/clothing/suit/armor/medium/vest/capcarapace(src)
	new /obj/item/clothing/suit/armor/medium/vest/capcarapace/alt(src)
...
/obj/structure/closet/secure_closet/hos/PopulateContents()
	...
	new /obj/item/clothing/suit/armor/medium/vest/leather(src)
	new /obj/item/clothing/suit/armor/medium/duster(src)
...
/obj/structure/closet/secure_closet/warden/PopulateContents()
	...
	new /obj/item/clothing/suit/armor/medium/vest/warden(src)
	new /obj/item/clothing/head/warden(src)
	new /obj/item/clothing/head/warden/drill(src)
	new /obj/item/clothing/head/beret/sec/navywarden(src)
	new /obj/item/clothing/suit/armor/medium/vest/warden/alt(src)
